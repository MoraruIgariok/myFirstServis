...
namespace MyFirstShop.Migrations
{
    ...
    [Migration("20230112194737_conex1")]
    partial class conex1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFirstShop.Table.DepositProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyFirstShop.Table.DepositProduct", b =>
                {
                    b.HasOne("MyFirstShop.Table.Deposit", "currentDeposit")
                        .WithMany("depositPorductList")
                        .HasForeignKey("DepositId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyFirstShop.Table.Product", "currentProduct")
                        .WithMany("depositPorductList")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("currentDeposit");
            ...
            modelBuilder.Entity("MyFirstShop.Table.Deposit", b =>
                {
                    b.Navigation("depositPorductList");
